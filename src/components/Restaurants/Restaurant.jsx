...
const Restaurant = () => {
  ...
  return (
    <>
    <div className="p-5 p-md-5 mb-1 rounded text-body-emphasis bg-dark">
    ...
    <img src="/assets/Restaurant9.jpg" alt="" srcset=""  className='Restimg'/>
  </div>
  <div className="row mb-2 black-bgrnd p-4" style={{width:'100vw', overflow:'hidden'}}>
    ...
    <div className="col-md-6 pt-5" key={item.id}>
      <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div className="col p-4 d-flex flex-column position-static">
          ...
          <button className='btn btn-dark w-50 mt-2'>Check Details</button>
        </div>
